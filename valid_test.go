...
func TestDepth(t *testing.T) {
	testCases := []struct {
		...
		{
			name:      "16-level array",
			data:      mustHexDecode("820181818181818181818181818181818101"),
			wantDepth: 16,
		},
		{
			name:      "16-level indefinite-length array",
			data:      mustHexDecode("9f0181818181818181818181818181818101ff"),
			wantDepth: 16,
		},
		{
			name:      "16-level map",
			data:      mustHexDecode("a10181818181818181818181818181818101"),
			wantDepth: 16,
		},
		{
			name:      "16-level indefinite-length map",
			data:      mustHexDecode("bf0181818181818181818181818181818101ff"),
			wantDepth: 16,
		},
		{
			name:      "16-level tag",
			data:      mustHexDecode("d864d864d864d864d864d864d864d864d864d864d864d864d864d864d864d864d86474323031332d30332d32315432303a30343a30305a"),
			wantDepth: 16,
