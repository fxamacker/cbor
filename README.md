...
# CBOR library in Go
This library is a CBOR encoder and decoder.  Each release passes 375+ tests and 250+ million execs in fuzzing with 1100+ CBOR files.   Choose this CBOR library if you value your time, data size, program size, and system reliability.
