...
* __Safe and reliable__ -- no `unsafe` pkg, coverage >95%, and 10+ hrs of [fuzzing](https://github.com/fxamacker/cbor-fuzz) before each release.
...
![alt text](https://user-images.githubusercontent.com/33205765/68237653-25426e80-ffcd-11e9-8511-5d64c3c72b84.png "Library and program size comparison chart")
...
Fuzzing uses [cbor-fuzz](https://github.com/fxamacker/cbor-fuzz) before each release.  Default corpus has 426 files:
* 4 files -- COSE and WebAuthn examples
* 82 files -- entire RFC 7049 test data
* 340 files -- data generated by fuzzing 50 hours

Unit tests include all RFC 7049 tests, 2 maliciously crafted CBOR data, bugs found by fuzzing, and etc.

Code coverage is 97.8% (`go test -cover`) for cbor v1.2.
